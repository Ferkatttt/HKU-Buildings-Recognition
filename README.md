...
This is an HKU buildings recognition app based on image recognition. The model is trainged using Tensorflow Lite. Click on "Clasify" to start the classification and the camera will pop up. Take a photo on the building and the app will automatically detect what that building is.
